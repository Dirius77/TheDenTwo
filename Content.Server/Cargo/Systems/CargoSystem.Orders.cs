        ...
        private void OnApproveOrderMessage(EntityUid uid, CargoOrderConsoleComponent component, CargoConsoleApproveOrderMessage args)
        {
            ...
            if (!_emag.CheckFlag(uid, EmagType.Interaction))
            {
                ...
                var message = Loc.GetString("cargo-console-unlock-approved-order-broadcast",
                    ...
                    ("cost", cost));
                _radio.SendLanguageRadioMessage(uid, message, account.RadioChannel, uid, escapeMarkup: false); // DEN: Language
                if (CargoOrderConsoleComponent.BaseAnnouncementChannel != account.RadioChannel)
                    _radio.SendLanguageRadioMessage(uid, message, CargoOrderConsoleComponent.BaseAnnouncementChannel, uid, escapeMarkup: false); // DEN: Language
            }
