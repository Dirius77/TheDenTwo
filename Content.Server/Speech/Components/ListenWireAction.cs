...
public sealed partial class ListenWireAction : BaseToggleWireAction
{
    ...
    public override void Pulse(EntityUid user, Wire wire)
    {
        ...
        _radio.SendLanguageRadioMessage(wire.Owner, noiseMsg, _protoMan.Index<RadioChannelPrototype>(radioMicroPhoneComp.BroadcastChannel), wire.Owner); // DEN: Languages
