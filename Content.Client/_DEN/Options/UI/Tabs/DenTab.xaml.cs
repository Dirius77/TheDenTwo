...
public sealed partial class DenTab : Control
{
    public DenTab()
    {
        ...
        Control.AddOptionDropDown(
            DenCCVars.HideLanguageFonts,
            HideLanguageFonts,
            [
                new OptionDropDownCVar<HideLanguageFontSetting>.ValueOption(
                    HideLanguageFontSetting.None,
                    Loc.GetString("ui-options-language-hide-fonts-none")
                    ),
                new OptionDropDownCVar<HideLanguageFontSetting>.ValueOption(
                    HideLanguageFontSetting.All,
                    Loc.GetString("ui-options-language-hide-fonts-all")
                ),
                new OptionDropDownCVar<HideLanguageFontSetting>.ValueOption(
                    HideLanguageFontSetting.Understood,
